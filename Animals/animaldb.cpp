...
//  Date: 4/13/21
// 
//  Purpose: Either prints all animals and their descriptions or all animals
//  that belong to user-inputted classification
//
...
/*
 * main function - runs all the functions needed for program to work properly
 */
                               ...
                               Animal_Array_List *all_animals) 
{
        ...
        int count = all_animals->num_animals();
        bool empty = true;
